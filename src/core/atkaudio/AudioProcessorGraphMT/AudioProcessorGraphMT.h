...
// Import JUCE types into atk namespace for AudioProcessorGraphMT
...
/**
    ...
    @tags{Audio}
*/
class JUCE_API AudioProcessorGraphMT
...
public:
    ...
    */
    ~AudioProcessorGraphMT() override;
    ...
    struct NodeID
    {
        ...
        explicit constexpr NodeID(uint32 i)
            : uid(i)
        {
        }
    ...
    */
    enum
    {
        midiChannelIndex = 0x1000
    };

    //==============================================================================
    /**
        Represents an input or output channel of a node in an AudioProcessorGraphMT.
    */
    ...
    //==============================================================================
    /** Represents one of the nodes, or processors, in an AudioProcessorGraphMT.

        To create a node, call AudioProcessorGraphMT::addNode().
    */
    ...
    public:
        ...
        */
        ...
        /** @internal
            ...
            To create a new node, use AudioProcessorGraphMT::addNode.
        */
    ...
    //==============================================================================
    /** Represents a connection between two channels of two nodes in an AudioProcessorGraphMT.

        To create a connection, use AudioProcessorGraphMT::addConnection().
    */
    ...
    */
    ...
    //==============================================================================
    /** A special type of AudioProcessor that can live inside an AudioProcessorGraphMT
    ...
    */
    ...
    public:
        ...
        AudioProcessorGraphMT* getParentGraph() const noexcept
        {
            return graph;
        }
        ...
        /** @internal */
        void setParentGraph(AudioProcessorGraphMT*);

    private:
        const IODeviceType type;
        AudioProcessorGraphMT* graph = nullptr;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(AudioProcessorGraphMT)
};
