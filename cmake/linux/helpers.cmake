...
function(set_target_properties_plugin target)
    ...
    add_custom_command(
        ...
        POST_BUILD
        COMMAND
            "${CMAKE_COMMAND}" -E make_directory "${CMAKE_CURRENT_BINARY_DIR}/rundir/$<CONFIG>"
        COMMAND
...
function(target_add_resource target resource)
    ...
    add_custom_command(
        ...
        COMMAND
            "${CMAKE_COMMAND}" -E make_directory "${CMAKE_CURRENT_BINARY_DIR}/rundir/$<CONFIG>/${target}"
        COMMAND
            "${CMAKE_COMMAND}" -E copy "${resource}" "${CMAKE_CURRENT_BINARY_DIR}/rundir/$<CONFIG>/${target}"
